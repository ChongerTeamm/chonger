		...
		<c:forEach items="${news }" var="item" varStatus="status">
			<c:choose>
				<c:when test="${status.index % 2 == 0}">
					<li class="odd" clstag="homepage|keycount|home2013|11b1"><a href="${item.url }" target="_blank" title="${item.title }">${item.title }</a></li>					
				</c:when>
				<c:otherwise>
					<li clstag="homepage|keycount|home2013|11b1"><a href="${item.url }" target="_blank" title="${item.title }">${item.title }</a></li>
				</c:otherwise>
			</c:choose>
		</c:forEach>
	</ul>
...
<div style="float:right">
	<img width="310" height="190" src="/images/QQ20181028115105.jpg" alt="" />
</div>
<div class="mc">
...
<div class="sm sm2 fore1 curr"  data-widget="tab-item"  clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>丽江古城</h3>
  </div>
...
<div class="smc">
	<img src="/images/QQ20181028111908.jpg" width="208" height="180" alt="" />
</div>
</div>
